...
<head>
    ...
    <title>ACOMIN OFFICIAL WEBSITE</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-sm-5">
                            <p><i class="ti-location-pin"></i> No. 6, Egbedi Close, Off Samuel Ladoke Akintola Boulevard, 
                                Garki 2, Abuja</p>
                        </div>
                        <div class="col col-sm-7">
                            <div class="social">
                                <ul>
                                    <li><a href="https://web.facebook.com/Acomin-247071375492732" target="_blank"><i class="ti-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/acomin11" target="_blank"><i class="ti-twitter-alt"></i></a></li>
                                    <!-- <li><a href="#"><i class="ti-vimeo-alt"></i></a></li> -->
                                    <li><a href="https://www.instagram.com/acomin77" target="_blank"><i class="ti-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img src="assets/images/logo/acoonly.png" width="180" height="50" alt="logo">
                            <span></span></a>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse navigation-holder">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="causes.php">Focus Areas</a>
                               
                            </li>
                            <li>
                                <a href="event.php">Programmes</a>
                    ...
                    <div class="cart-search-contact">
                        ...
                        <div class="vollenter-btn">
                            <a class="theme-btn-s2" href="contact.php">Volunteer with us</a>
                        </div>
                    </div>
